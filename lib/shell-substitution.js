...
export function extractCommandSubstitutions(input) {
...
export function extractSubshellGroups(input) {
    const source = String(input || '');
    const groups = [];
    let inSingle = false;
    let inDouble = false;
 ...
 */
export function extractBraceGroups(input) {
    const source = String(input || '');
    const groups = [];
    let inSingle = false;
    let inDouble = false;
...
//# sourceMappingURL=shell-substitution.js.map